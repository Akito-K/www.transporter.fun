...
var estimate_1 = __webpack_require__(10);
...
(function (Upload) {
    var MyUpload = /** @class */ (function () {
        ...
        MyUpload.prototype.ajaxUploadFileAndPutBoardFile = function (fd, target, filename) {
            var self = this;
            self.ajaxing = true;
            var token = $('meta[name="csrf-token"]').attr('content');
...
(function (Order) {
    var MyOrder = /** @class */ (function () {
        function MyOrder(ajaxing) {
            ...
            $('.trigTotalWeight').keyup(function () {
...
(function (Estimate) {
    var MyEstimate = /** @class */ (function () {
        function MyEstimate(STAR, ajaxing, htmlOptions) {
            ...
            // 項目追加
            $('#trigAddItem').click(function () {
                var num = Number($('#trigAddItem').attr('data-num'));
                _this.ajaxAddItem(num);
            });
            // 計算
        ...
        MyEstimate.prototype.refreshSubTotal = function (num) {
            var amount = func_1.default.number($('.paramAmount[data-num="' + num + '"]').val());
            var count = func_1.default.number($('.paramCount[data-num="' + num + '"]').val());
        ...
        MyEstimate.prototype.ajaxAddItem = function (num) {
            ...
            self.ajaxing = true;
            var token = $('meta[name="csrf-token"]').attr('content');
            var D = { latest_num: num, html_options: self.htmlOptions };
            $.ajax({
                headers: { 'X-CSRF-TOKEN': token },
