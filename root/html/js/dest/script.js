...
var signup_1 = __webpack_require__(2);
//import Model from './model';
$(function () {
    //    Func.hoge();
    // 会員登録
    var SIGNUP = new signup_1.default.MySignup();
});
...
var Signup;
(function (Signup) {
    var MySignup = /** @class */ (function () {
        function MySignup(ajaxing) {
        ...
        MySignup.prototype.checkNextBtn = function () {
            var flagOwner = $('input[name="flag_owner"]').prop('checked');
            var flagCarrier = $('input[name="flag_carrier"]').prop('checked');
        ...
        MySignup.prototype.checkNextBtnEpsilon = function () {
            var checks = $('.trigCheckAccept');
            var flagError = false;
