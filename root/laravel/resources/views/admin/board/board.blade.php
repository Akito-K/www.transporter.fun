...
@section('content')
{!! Form::hidden('', $customer->hashed_id, ['id' => 'paramHashedId']) !!}
    ...
    <div class="box">
        <div class="box-body board-area" id="board-area">
            ...
            <div class="board__block">
                <div class="board__order">
                    @include('include.admin.customer', ['data' => $customer])
                </div>
                <!-- /.board__order -->
                ...
                <div class="board__content" id="board-content">
                    ...
                    <div class="board__content__boxes board__content__boxes--over10" id="over10" data-board_id="{!! $customer->board_id !!}">
                    </div>

                    <div class="board__content__boxes board__content__boxes--latest10" id="latest10">
                        @include('include.admin.messages', ['messages' => $latest10, 'user' => $customer])
                    </div>

                </div>
                <!-- /.board__content -->

                <div class="board__input" id="board-input" data-user_hashed_id="{!! $customer->hashed_id !!}">
                    <ul class="board__input__lists">
                        ...
                        <li class="board__input__list board__input__list--memo">
                            {!! \Form::checkbox('flag_memo', 1, null, ['id' => 'flag_memo']) !!} <label for="flag_memo">メモ</label>
                        </li>
        ...
        <a href="{{ url('') }}/admin/boards" class="btn btn-block btn-primary">一覧へ戻る</a>
    </div>
