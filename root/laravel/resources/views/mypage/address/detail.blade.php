            ...
            <div class="address__box">
                <div class="address__box-wrap">
                    ...
                    <ul class="address__lists">
                        ...
                        <li class="address__list address__list--value">〒 {{ $data->zip1 }} - {{ $data->zip2 }}</li>
                    </ul>
                    <ul class="address__lists">
                        <li class="address__list address__list--title">都道府県</li>
                        <li class="address__list address__list--value">{{ $prefs[ $data->pref_code ] }}</li>
                    </ul>
                    <ul class="address__lists">
                        <li class="address__list address__list--title">市区町</li>
                        <li class="address__list address__list--value">{{ $data->city }}</li>
                    </ul>
                    <ul class="address__lists">
                        <li class="address__list address__list--title">以降の住所</li>
                        <li class="address__list address__list--value">{{ $data->address }}</li>
                    </ul>
                    <ul class="address__lists">
                        <li class="address__list address__list--title">電話番号</li>
                        <li class="address__list address__list--value">{{ $data->tel }}</li>
                    </ul>
                </div>
            </div>
