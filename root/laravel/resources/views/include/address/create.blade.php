...
<ul class="lists">
    ...
    <li class="list list-value">
        ...
        - {!! \Form::number($prefix_zip2, old($prefix_zip2), ['class' => 'form-control form-control--mini form-control--40', 'id' => $prefix_zip2, 'onKeyUp' => 'AjaxZip3.zip2addr(\''.$prefix.'zip1\', \''.$prefix.'zip2\', \''.$prefix.'pref_id\',\''.$prefix.'city\', \''.$prefix.'address\');']) !!}
    </li>
</ul>
<ul class="lists">
    <li class="list list-title must">都道府県</li>
    <li class="list list-value">
        {!! \Form::select($prefix_pref_id, $prefs, old($prefix_pref_id), ['class' => 'form-control', 'id' => $prefix_pref_id]) !!}
    </li>
</ul>
<ul class="lists">
