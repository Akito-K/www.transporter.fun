        ...
        <div class="container">
            ...
            <nav class="gnav">
                <ul>
                    ...
                    <li><a href="{{ env('help_url') }}/transporter/000.php">トランスポーターとは</a></li>
            ...
            <div class="search col">
                ...
                <div class="col4">
                    <div class="btn_select">
                        ...
                        <div class="child_wrap">
                            <ul class="child">
                                <li><a href="{{ env('www_url') }}/delivery_services/Category/CLS-01">ウイング便（13t以下）</a></li>
                                <li><a href="{{ env('www_url') }}/delivery_services/Category/CLS-02">平車（13t以下）</a></li>
                                <li><a href="{{ env('www_url') }}/delivery_services/Category/CLS-03">トレーラー（32t以下）</a></li>
                                <li><a href="{{ env('www_url') }}/delivery_services/Category/CLS-04">トレーラー（70t以下）</a></li>
                                <li><a href="{{ env('www_url') }}/delivery_services/Category/CLS-05">重量物・その他大型特殊車両（200t以下）</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col4"><a class="btn_style01" href="{{ env('www_url') }}/delivery_services/Regularly">定期案件</a></div>
                <div class="col4"><a class="btn_style01" href="{{ env('www_url') }}/delivery_services/Occasionally">スポット案件</a></div>
                <div class="col4 pos_relative">
                    <div class="special_menu_wrap">
                        ...
                        <ul class="menu">
                            <li><a href="{{ env('help_url') }}/transporter/000.php">
                                <span class="text">トランスポーターとは？</span><span class="img"><img src="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon1.png" alt="" width="39" height="28" srcset="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon1.png 1x,{{ env('www_url') }}/assets/images/home/special_menu_icon/icon1@2x.png 2x"></span></a></li>
                            <li><a href="{{ env('help_url') }}/transporter/006.php#14free">
                                <span class="text">14日間無料お試し</span><span class="img"><img src="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon2.png" alt="" width="51" height="18" srcset="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon2.png 1x,{{ env('www_url') }}/assets/images/home/special_menu_icon/icon2@2x.png 2x"></span></a></li>
                            <!--li><a href="{{ env('help_url') }}/transporter/.php">
                                <span class="text">人気運送会社ランキング</span><span class="img"><img src="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon4.png" alt="" width="37" height="28" srcset="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon4.png 1x,{{ env('www_url') }}/assets/images/home/special_menu_icon/icon4@2x.png 2x"></span></a></li-->
                            <li><a href="{{ env('www_url') }}/transport_news">
                                <span class="text">物流ニュース</span><span class="img"><img src="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon5.png" alt="" width="36" height="36" srcset="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon5.png 1x,{{ env('www_url') }}/assets/images/home/special_menu_icon/icon5@2x.png 2x"></span></a></li>
                            ...
                            <!--li><a href="{{ env('www_url') }}/qa">
                                <span class="text">よくあるご質問</span><span class="img"><img src="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon7.png" alt="" width="35" height="35" srcset="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon7.png 1x,{{ env('www_url') }}/assets/images/home/special_menu_icon/icon7@2x.png 2x"></span></a></li-->
                            <li><a target="_blank" href="{{ env('www_url') }}/compliance">
                                <span class="text">コンプライアンス輸送</span><span class="img"><img src="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon8.png" alt="" width="33" height="33" srcset="{{ env('www_url') }}/assets/images/home/special_menu_icon/icon8.png 1x,{{ env('www_url') }}/assets/images/home/special_menu_icon/icon8@2x.png 2x"></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
