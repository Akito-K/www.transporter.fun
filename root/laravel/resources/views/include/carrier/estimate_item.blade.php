...
<tr class="bulletRemoveItem" data-num="{{ $num }}">
    <td class="estimate__table__cell estimate__table__cell--line">
        {!! Form::text('item_code['.$num.']', '', ['class' => 'form-control  form-control--xsm', 'data-num' => $num, 'id' => 'code_'.$num ]) !!}
    </td>
    <td class="estimate__table__cell estimate__table__cell--line" colspan="2">
        {!! Form::text('item_name['.$num.']', '', ['class' => 'form-control  form-control--xsm', 'data-num' => $num, 'id' => 'name_'.$num ]) !!}
    </td>
    <td class="estimate__table__cell estimate__table__cell--line">
        {!! Form::number('item_amount['.$num.']', '', ['class' => 'form-control  form-control--xsm trigCalculateSubTotal paramAmount', 'data-num' => $num, 'id' => 'amount_'.$num ]) !!}
    </td>
    <td class="estimate__table__cell estimate__table__cell--line">
        {!! Form::number('item_count['.$num.']', '', ['class' => 'form-control  form-control--xsm trigCalculateSubTotal paramCount', 'data-num' => $num ]) !!}
    </td>
    <td class="estimate__table__cell estimate__table__cell--line">
        {!! Form::text('item_subtotal['.$num.']', '', ['class' => 'form-control  form-control--xsm paramSubtotal bulletSubTotal readonly', 'readonly' => 'readonly', 'data-num' => $num ]) !!}
    </td>
</tr>
<tr class="estimate__table__margin-bottom bulletRemoveItem" data-num="{{ $num }}">
    ...
    <td class="estimate__table__cell estimate__table__cell--notes estimate__table__cell--line" colspan="4">
        {!! Form::textarea('item_notes['.$num.']', '', ['class' => 'form-control form-control--xsm paramNote bulletNotes', 'data-num' => $num, 'id' => 'notes_'.$num, 'placeholder' => '' ]) !!}
    </td>
