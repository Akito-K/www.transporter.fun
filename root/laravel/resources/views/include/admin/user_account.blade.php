...
<li class="dropdown user user-menu">
    ...
    <a href="#" class="dropdown-toggle header__account__wrap" data-toggle="dropdown">
        ...
        <span class="hidden-xs header__account__child">{!! \Auth::user()->sei.\Auth::user()->mei.'さん' !!}</span>
    </a>
    <ul class="dropdown-menu">
        ...
        <li class="user-header">
            ...
            <p>
                {!! \Auth::user()->sei.\Auth::user()->mei.'さん' !!} - @if(\Func::isDeveloper()) 開発者 @elseif(\Func::isManager()) 管理者 @else 一般職員 @endif
