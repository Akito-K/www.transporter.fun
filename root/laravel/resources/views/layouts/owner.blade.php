...
<head>
    ...
    <link href="{{ url('') }}/css/dest/owner.css" rel="stylesheet">
...
<body class="hold-transition sidebar-mini {!! $pagemeta->body_class !!} skin-red">
        ...
        <div class="content-wrapper">
          <!-- Content Header (Page header) -->
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="{{ url('') }}/owner/dashboard"><i class="fa fa-dashboard"></i> 荷主ページ</a></li>
