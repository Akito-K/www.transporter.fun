...
<div class="page_all page_main page_col2">
    <div class="container">
        ...
        <article class="content">
            ...
            <section class="sec">
                <div class="text_wrap">
                    <p>トランスポーターでは、一般公道で特殊大型重量品の運搬を行うために必要な特殊車両通行許可の申請を推奨しています。許可取得後、輸送計画に基づき作業員の確保、誘導車両の手配、当日の輸送まで、一貫して全ての作業を行います。車両サイズが下記一般的制限値のどれか1つでも越える車両が道路を通行するには「特殊車両通行許可」が必要になります。</p>
                </div>
            </section>
            <section class="sec">
