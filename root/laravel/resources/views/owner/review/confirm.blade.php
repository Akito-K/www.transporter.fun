...
<div class="box">
    <div class="box-body">
        <h2 class="page-header">この案件の運送会社はいかがでしたか？（確認画面）</h2>

        <div class="request__block">
            {!! Form::open(['url' => 'owner/review/execute', 'class' => 'work__boxes']) !!}
                ...
                <a href="{{ url('') }}/owner/review/{{ old('order_id') }}/create" class="btn btn-block btn-primary">入力画面に戻る</a>
            {!! \Form::close() !!}
        </div>
