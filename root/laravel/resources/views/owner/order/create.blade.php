            ...
            {!! Form::open(['url' => 'owner/order/confirm', 'class' => 'order__boxes']) !!}
                            ...
                            <ul class="params">
                                <li class="param param-50">
                                    <div class="date-input trigShowCalendar" data-calendar="send">
                                        {!! Form::text('send_at', '', ['id' => 'send_at', 'placeholder' => '任意', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
                                        {!! Form::hidden('hide_send_at', '', ['id' => 'hide_send_at']) !!}
                                        <i class="fa fa-calendar"></i>
                                    </div>
                                </li>
                                <li class="param param-50">
                                    {!! \Form::select('send_timezone', $timezones, old('send_timezone'), ['class' => 'form-control']) !!}
                                </li>
                            </ul>
                        </li>
                    </ul>
                            ...
                            <ul class="params">
                                <li class="param param-50">
                                    <div class="date-input trigShowCalendar" data-calendar="arrive">
                                        {!! Form::text('arrive_at', '', ['id' => 'arrive_at', 'placeholder' => '任意', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
                                        {!! Form::hidden('hide_arrive_at', '', ['id' => 'hide_arrive_at']) !!}
                                        <i class="fa fa-calendar"></i>
                                    </div>
                                </li>
                                <li class="param param-50">
                                    {!! \Form::select('arrive_timezone', $timezones, old('arrive_timezone'), ['class' => 'form-control']) !!}
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="order__box bulletAccordOrderBox initial-close">
                    ...
                    <ul class="lists">
                        ...
                        <li class="list list-value">
                            <span id="bulletTotalWeight">0</span> kg
                        </li>
                    </ul>
                    <ul class="lists">
                        ...
                        <li class="list list-value">
                            ...
                            <ul class="params params-left">
                                ...
                                <li class="param param-40 param-left">
                                    {!! \MyForm::radio('option_equipments['.$key.']', $umu, old('option_equipments['.$key.']')?: 0, ['class' => ''], 'span') !!}
                                </li>
                                @endif
                    ...
                    <ul class="lists">
                        ...
                        <li class="list list-value">
                            ...
                            <ul class="params params-left">
                                ...
                                <li class="param param-40 param-left">
                                    {!! \MyForm::radio('option_others['.$key.']', $umu, old('option_others['.$key.']')?: 0, ['class' => ''], 'span') !!}
                                </li>
                            </ul>
                            @endforeach
                            @endif
