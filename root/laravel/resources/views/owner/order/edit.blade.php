            ...
            {!! Form::open(['url' => 'owner/order/'.$data->order_id.'/confirm', 'class' => 'order__boxes']) !!}
                ...
                <div class="order__box bulletAccordOrderBox">
                    ...
                    <ul class="lists">
                        ...
                        <li class="list list-value">
                            {!! \MyForm::radio('flag_hide_owner', $hide_owners, old('flag_hide_owner', $data->flag_hide_owner)? 1: 0, ['class' => ''], 'span') !!}
                        </li>
                    </ul>
                    <ul class="lists">
                            ...
                            <ul class="params">
                                <li class="param param-50">
                                    <div class="date-input trigShowCalendar" data-calendar="send">
                                        {!! Form::text('send_at', old('send_at', $data->send_at_str), ['id' => 'send_at', 'placeholder' => '任意', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
                            ...
                            <ul class="params">
                                <li class="param param-50">
                                    <div class="date-input trigShowCalendar" data-calendar="arrive">
                                        {!! Form::text('arrive_at', old('arrive_at', $data->arrive_at_str), ['id' => 'arrive_at', 'placeholder' => '任意', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
                ...
                <div class="order__box bulletAccordOrderBox">
                    ...
                    @include('include.address.edit', ['prefix' => 'send_', 'data' => $data])
                </div>
                ...
                <div class="order__box bulletAccordOrderBox initial-close">
                    ...
                    @include('include.address.edit', ['prefix' => 'arrive_', 'data' => $data])
                </div>
                    ...
                    <ul class="lists">
                        ...
                        <li class="list list-value">
                            <span class="bulletTotalWeight">
                                {{ number_format( old('total_weight', $data->total_weight) ) }}
                            </span> kg
                        ...
                        <li class="list list-value">
                            ...
                            <ul class="params params-left">
                                ...
                                <li class="param param-40 param-left">
                                    {!! \MyForm::radio('option_equipments['.$key.']', $umu, old('option_equipments.'.$key, $data->option_equipments[$key])? 1: 0, ['class' => ''], 'span') !!}
                                </li>
                                @endif
                    ...
                    <ul class="lists">
                        ...
                        <li class="list list-value">
                            ...
                            <ul class="params params-left">
                                ...
                                <li class="param param-40 param-left">
                                    {!! \MyForm::radio('option_others['.$key.']', $umu, old('option_others.'.$key, $data->option_others[$key])? 1: 0, ['class' => ''], 'span') !!}
                                </li>
                            </ul>
                            @endforeach
                            @endif
