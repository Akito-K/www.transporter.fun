...
<div class="box">
    <div class="box-body">
        ...
        <div class="request__block">
            {!! Form::open(['url' => 'owner/nominate_request/confirm', 'class' => 'request__boxes']) !!}
                ...
                <div class="request__box">
                    <ul class="lists">
                        ...
                        <li class="list list-value">
                            {!! Form::select('carrier_id', $select_carriers_names, old('carrier_id'), ['class' => 'form-control', 'id' => 'paramQuoteCarrier']) !!}
                            <button type="button" class="btn btn-default" id="trigQuoteCarrier">指定運送会社を変更する</button>
                        </li>
                    </ul>

                    <div class="request__order__carrier" id="bulletQuoteCarrier">
                    </div>
