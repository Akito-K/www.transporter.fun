...
class orderController extends ownerController
{
    ...
    public function confirm(MyRequest $request){
        ...
        return view('owner.order.confirm', compact('pagemeta', 'carrier_classes', 'addresses', 'prefs', 'timezones', 'hide_owners', 'cargo_names', 'cargo_forms', 'option_car_names', 'option_equipments', 'option_other_names', 'umu'));
    }
